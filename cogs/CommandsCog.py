...
class Commands(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name='***Information Commands:***', value="*** ***", inline=False)
        ...
        embed.add_field(name='*Administrator Commands:*', value="*** ***", inline=False)
        embed.add_field(name='set_prefix <prefix>{"setprefix", "set-prefix"}',
                        value="You can set your custom prefix for the bot", inline=False)
        embed.add_field(name='set_trigger_value <trigger_value>{"stv", "set-trigger-value"}', value='You can set your custom trigger value for the "AutomaticRoles"', inline=False)
